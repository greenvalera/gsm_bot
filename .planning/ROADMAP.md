...
- [x] 07-02-PLAN.md — Civil-date, 24-hour range and natural-duration presentation.

**Wave 3 *(blocked on Wave 2 completion)***

- [x] 07-03-PLAN.md — Complete Ukrainian planning, availability and controls.

**Wave 4 *(blocked on Wave 3 completion)***

- [x] 07-04-PLAN.md — Manual booking, replanning, cancellation and lifecycle recovery.

**Wave 5 *(blocked on Wave 4 completion)***

- [x] 07-05-PLAN.md — Existing instructions, semantic denials and stale/error boundaries.

**Wave 6 *(blocked on Wave 5 completion)***

- [x] 07-06-PLAN.md — Safe mid-round switching, no-op refresh and recovery hardening.
...
**Plans**: 4/5 plans executed; Plan 08-05 must close the explicit outbound evidence residuals.
...
- [x] 08-02-PLAN.md — Localized follow-up delivery, navigation and mention safety.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 08-03-PLAN.md — Durable language-switch, claim and recovery regressions.

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 08-04-PLAN.md — Migrated-chat recovery localization, strict catalog contracts and outbound-surface inventory.
...
| 8. Localized Reminders and Bilingual Verification | v1.1 | 4/5 | In Progress|  |
