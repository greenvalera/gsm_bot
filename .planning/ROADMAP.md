...
- [ ] **Phase 6: Localization Foundation and Ukrainian Onboarding** — Persistent group language and a complete Ukrainian setup/settings/roster slice.
...
- [ ] 06-01-PLAN.md — Persisted-locale settings tracer and blocking migration verification.

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 06-02-PLAN.md — Administrator language selection, first setup and incomplete settings.
...
- [ ] 06-04-PLAN.md — Ukrainian settings and safe open edits.

**Wave 5** *(blocked on Wave 4 completion)*

- [ ] 06-05-PLAN.md — Ukrainian roster display and member actions.
...
|---|---|---|---|---|
| 6. Localization Foundation and Ukrainian Onboarding | v1.1 | 0/7 | Planned | — |
