...
export function verifyNonProduction(
  ...
  if (site.nonProduction === "dominated-setup-fallback") {
    ...
    // Re-reviewed for quick task 260922-uwu: callbacks.ts only gained the
    // ROSTER_JOIN route and its import; dispatchSetupCallback is still called
    // solely from the START_SETUP entry.
    return (
      hash((sources[site.file] ?? "").replaceAll("\r\n", "\n")) ===
        "14bb8487f48cc94c16b6" &&
      hash(
        (sources["src/telegram/callbacks.ts"] ?? "").replaceAll("\r\n", "\n"),
      ) === "dafa8a32754234443867" &&
...
const catalogPaths: string[][] = [
  ...
  ["roster.inviteButton"],
  ["roster.added", "roster.alreadyActive", "roster.fallback"],
  [
    "common.saveFailure",
    "roster.added",
    "roster.alreadyActive",
...
export const outboundSurfaces: OutboundSurface[] = [
  ...
  },
  {
    ...
    dependencies: "385a14d1dd36b4598f82",
    keys: catalogPaths[105]!,
    evidence: {
      file: "tests/integration/localized-onboarding.e2e.test.ts",
  ...
  },
  {
    ...
    dependencies: "ba7f6b4a04f7ea53fbf4",
    keys: catalogPaths[106]!,
    evidence: {
  ...
  },
  {
    ...
    expression: "ctx.answerCallbackQuery()",
    digest: "1df1de9109e0f91316bf",
    dependencies: "02c851dbb48028f668ed",
  ...
  },
  {
    ...
    expression: "ctx.answerCallbackQuery()",
    digest: "1df1de9109e0f91316bf",
    dependencies: "8f20f204eb3f744f0661",
  ...
  },
  {
    ...
    dependencies: "b458ae3a01ae50674349",
  ...
  },
  {
    ...
    dependencies: "821281a0c017c4916699",
    keys: catalogPaths[107]!,
    evidence: {
      file: "tests/unit/roster-localization.test.ts",
  ...
  {
    id: "src/telegram/keyboards.ts#module:factory.rosterInviteKeyboard:1",
    file: "src/telegram/keyboards.ts",
    locator: "module:factory.rosterInviteKeyboard:1",
    kind: "projection",
    expression:
      'export function rosterInviteKeyboard(joinToken: string, locale: Locale = "en") {\n  return new InlineKeyboard().text(\n    renderMessage(locale, "roster.inviteButton", undefined),\n    joinToken,\n  );\n}',
    digest: "7729b5d0d954d7c3c6c0",
    dependencies: "cd7878aa26d927e4f054",
    keys: catalogPaths[108]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "invites an unknown @username and adds the matching Join presser in %s",
      locales: ["en", "uk"],
    },
  },
  {
    id: "src/telegram/keyboards.ts#rosterInviteKeyboard:keyboard.text:1",
    file: "src/telegram/keyboards.ts",
    locator: "rosterInviteKeyboard:keyboard.text:1",
    kind: "button",
    expression:
      'new InlineKeyboard().text(\n    renderMessage(locale, "roster.inviteButton", undefined),\n    joinToken,\n  )',
    digest: "80058dfc2df3a431c3a1",
    dependencies: "cd7878aa26d927e4f054",
    keys: catalogPaths[108]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
  ...
  {
    id: "src/telegram/roster-invite-handlers.ts#module:factory.renderInviteAddConfirmation:1",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "module:factory.renderInviteAddConfirmation:1",
    kind: "projection",
    expression:
    ...
    digest: "ee32e9f9fe733bbc57c9",
    dependencies: "513cb451e2d191a30c6b",
    keys: catalogPaths[109]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "adds a text_mention user directly without an invite in %s",
      locales: ["en", "uk"],
    },
  },
  {
    id: "src/telegram/roster-invite-handlers.ts#handleRosterAddArgument:reply:1",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "handleRosterAddArgument:reply:1",
    kind: "message",
    expression:
      'ctx.reply(\n          renderMessage(locale, "roster.invitePrompt", {\n            username: invite.username,\n          }),\n          {\n            parse_mode: "HTML",\n            reply_markup: rosterInviteKeyboard(invite.token, locale),\n          },\n        )',
    digest: "25c688c8d4c31a357218",
    dependencies: "77ea13d5edf385035f7f",
    keys: catalogPaths[110]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "invites an unknown @username and adds the matching Join presser in %s",
      locales: ["en", "uk"],
  ...
  {
    id: "src/telegram/roster-invite-handlers.ts#handleRosterAddArgument:reply:2",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "handleRosterAddArgument:reply:2",
    kind: "message",
    expression:
      'ctx.reply(\n      renderInviteAddConfirmation(added, await inviteLocale(deps, context)),\n      { parse_mode: "HTML" },\n    )',
    digest: "10477d0564107701bd9f",
    dependencies: "77ea13d5edf385035f7f",
    keys: catalogPaths[110]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
  ...
  {
    id: "src/telegram/roster-invite-handlers.ts#handleRosterAddArgument:reply:3",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "handleRosterAddArgument:reply:3",
    kind: "message",
    expression:
      'ctx.reply(\n      renderMessage(\n        await inviteLocale(deps, context),\n        "common.saveFailure",\n        undefined,\n      ),\n    )',
    digest: "a8048d4cb8308e0ac3d3",
    dependencies: "77ea13d5edf385035f7f",
    keys: catalogPaths[110]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "reports a failed invite write without logging the username in %s",
      locales: ["en", "uk"],
    },
  },
  {
    id: "src/telegram/roster-invite-handlers.ts#dispatchRosterJoinCallback:editMessageText:1",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "dispatchRosterJoinCallback:editMessageText:1",
    kind: "edit",
    expression:
      'ctx.editMessageText(\n        renderInviteAddConfirmation(outcome.result, locale),\n        { parse_mode: "HTML" },\n      )',
    digest: "23fdeb5c4640f8ef9f14",
    dependencies: "60dba126f96c5d0280e9",
    keys: catalogPaths[111]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "invites an unknown @username and adds the matching Join presser in %s",
      locales: ["en", "uk"],
  ...
  {
    id: "src/telegram/roster-invite-handlers.ts#dispatchRosterJoinCallback:answerCallbackQuery:1",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "dispatchRosterJoinCallback:answerCallbackQuery:1",
    kind: "alert",
    expression: "ctx.answerCallbackQuery({ text: refusal, show_alert: true })",
    digest: "274b45e1136b30241ab4",
    dependencies: "60dba126f96c5d0280e9",
    keys: catalogPaths[111]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "answers stale, consumed and non-member Join presses without changes in %s",
      locales: ["en", "uk"],
    },
  },
  {
    id: "src/telegram/roster-invite-handlers.ts#dispatchRosterJoinCallback:text:1",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "dispatchRosterJoinCallback:text:1",
    kind: "projection",
    expression: "refusal",
    digest: "424fb0794608103b88e8",
    dependencies: "60dba126f96c5d0280e9",
    keys: catalogPaths[111]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
  ...
  {
    id: "src/telegram/roster-invite-handlers.ts#dispatchRosterJoinCallback:answerCallbackQuery:2",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "dispatchRosterJoinCallback:answerCallbackQuery:2",
    kind: "alert",
    expression:
      'ctx.answerCallbackQuery({\n      text: renderMessage(\n        await inviteLocale(deps, context),\n        "common.saveFailure",\n        undefined,\n      ),\n      show_alert: true,\n    })',
    digest: "769eeaace9fa10f9c519",
    dependencies: "60dba126f96c5d0280e9",
    keys: catalogPaths[111]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
      case: "reports a failed Join write without changing the roster in %s",
      locales: ["en", "uk"],
    },
  },
  {
    id: "src/telegram/roster-invite-handlers.ts#dispatchRosterJoinCallback:text:2",
    file: "src/telegram/roster-invite-handlers.ts",
    locator: "dispatchRosterJoinCallback:text:2",
    kind: "projection",
    expression:
      'renderMessage(\n        await inviteLocale(deps, context),\n        "common.saveFailure",\n        undefined,\n      )',
    digest: "80e03a53ea488d9374e3",
    dependencies: "60dba126f96c5d0280e9",
    keys: catalogPaths[111]!,
    evidence: {
      file: "tests/unit/roster-invite.test.ts",
