...
export type MessageParameters = {
  ...
  "planning.lifecycle.slot": { value: string; time: string };
  "planning.lifecycle.retired": { value: string };
  "planning.lifecycle.cancelPrompt": { value: string };
  "planning.lifecycle.changePrompt": { value: string };
  "planning.lifecycle.cancelledHeading": { value: string };
  "planning.lifecycle.superseded": { value: string };
  "planning.lifecycle.blockedHeading": { value: string };
  "planning.lifecycle.blocked": undefined;
  "planning.lifecycle.readyHeading": { value: string };
  "planning.lifecycle.readyMembers": undefined;
  "planning.lifecycle.ready": undefined;
  "planning.lifecycle.retractedHeading": { value: string };
  "planning.lifecycle.retracted": undefined;
  "planning.lifecycle.bookedHeading": { value: string };
  "planning.lifecycle.booked": undefined;
  "planning.lifecycle.bookingHeading": { value: string };
